...
>
  <header class="grid grid-cols-[1fr_180px]">
    ...
    <div class="flex h-[160px] w-[160px] items-center justify-center">
      <img src={logoUrl} alt="Club logo" class="object-contain" />
    </div>
  </header>

  <main class="mt-6 space-y-24">
    <!-- Match Details -->
    <section class="mx-auto grid max-w-6xl grid-cols-[120px_1fr] items-center gap-x-4 gap-y-2">
    ...
    <!-- Player Section -->
    <section class="mx-12 grid grid-cols-[720px_1fr] gap-10">
      <div>
